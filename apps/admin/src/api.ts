...
export const adminApi = {
  ...
  deleteOffer(id: string) {
    return del<{ ok: boolean }>(`/admin/moderation/offers/${id}`)
  },
  createPartner(body: { businessName: string; email: string; password: string; phone?: string; category?: string }) {
    return post<{ partner: PartnerAdminItem }>('/admin/partners', body)
  },
  partners() {
