...
/** Small square badge with a gradient fill — used for feature/category icons (e.g. 🚗, ⛽, 🏆). */
...
export function MoneyText({ value, sign = false, tone, size = 18, suffix = "so'm", style }: { value: number; sign?: boolean; tone?: 'text' | 'success' | 'danger' | 'secondary'; size?: number; suffix?: string; style?: React.CSSProperties }) {
  ...
  return (
    <span style={{ color, fontSize: size, fontWeight: 700, fontVariantNumeric: 'tabular-nums', letterSpacing: -0.3, ...style }}>
      {signStr}
